...
export type GetInitialStatesInput = z.input<typeof GetInitialStatesInputSchema>;

export const GetInitialStatesOutputSchema = z.object({
  initialStates: z
    .array(z.array(z.string()))
    .describe(
      "One row per initial state; each row holds `[stateName, annotation]` as raw strings.",
    ),
});
...
export const GetInitialStatesDescription =
  "Return the list of initial states declared in the class.";
