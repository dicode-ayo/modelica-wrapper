...
export const GetExtendsModifierNamesOutputSchema = z.object({
  modifiers: z
    .array(z.string())
    .describe("Modifier names declared on the targeted `extends` clause."),
});
export type GetExtendsModifierNamesOutput = z.infer<
  typeof GetExtendsModifierNamesOutputSchema
>;

export const GetExtendsModifierNamesDescription =
  "Return the names of the modifiers attached to an `extends` clause.";
