...
export const SetSourceFileInputSchema = z.object({
  ...
  fileName: z
    .string()
    .describe(
      "New source file path to associate with the class in OMC's symbol table.",
    ),
});
...
export const SetSourceFileDescription =
  "Set the source filename associated with a class in OMC's symbol table.";
