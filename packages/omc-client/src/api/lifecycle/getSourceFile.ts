...
export const GetSourceFileOutputSchema = z.object({
  fileName: z
    .string()
    .describe(
      "Source file path for the class, or empty when no file is bound.",
    ),
});
export type GetSourceFileOutput = z.infer<typeof GetSourceFileOutputSchema>;

export const GetSourceFileDescription =
  "Return the source filename associated with the class in OMC's symbol table.";
