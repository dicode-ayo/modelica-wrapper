...
|---|---|---|---|
| Browsing | 33 | 33 | All ✅. Custom fixtures cover `isClass`, `isReplaceable`, `isProtectedClass`, and the #42 extras (`extendsFrom`, `getAllSubtypeOf`, `classAnnotationExists`, `getNthInheritedClass`, `isShortDefinition`). |
