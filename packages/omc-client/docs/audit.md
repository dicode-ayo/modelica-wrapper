...
A runbook for verifying that `@dicode/omc-client` stays consistent with the upstream OpenModelica scripting API documentation **at the pinned OMC version**.
