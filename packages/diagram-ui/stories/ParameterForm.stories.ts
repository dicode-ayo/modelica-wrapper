    ...
    model: {
      ...
      fields: [
        ...
        },
        {
          ...
          value: 500,
          defaultValue: 500,
          dialog: { tab: "General", group: "Solver" },
          unitOptions: [],
        },
        {
          name: "tolerance",
        ...
        },
        {
          ...
          value: "mat",
          defaultValue: "mat",
          enumChoices: ["mat", "csv", "plt", "empty"],
          dialog: { tab: "General", group: "Output" },
          unitOptions: [],
        },
        {
          name: "variableFilter",
  ...
  args: {
    ...
    model: {
      ...
      fields: [
        ...
        {
          name: "stateSelect",
          label: "State selection priority for phi and w.",
          kind: "enum",
          value: "default",
          defaultValue: "default",
          enumChoices: ["default", "always", "prefer", "avoid", "never"],
          dialog: G,
          unitOptions: [],
        },
      ],
  ...
  args: {
    ...
    model: {
      ...
      fields: [
        {
          name: "startTime",
          label: "Time instant at which movement starts.",
          kind: "number",
          value: 0.5,
          defaultValue: 0.5,
          unit: "s",
  ...
  args: {
    ...
    model: {
      ...
      fields: [
        {
          name: "name",
          label: "Required free-text. Submit is disabled until non-empty.",
          kind: "string",
          value: null,
          dialog: G,
          unitOptions: [],
