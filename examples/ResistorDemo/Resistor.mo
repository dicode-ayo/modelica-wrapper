...
equation
  ...
  annotation(
    ...
    Diagram(graphics = {Rectangle(origin = {20, 20}, lineColor = {255, 0, 0}, fillColor = {0, 0, 0}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, borderPattern = BorderPattern.None, extent = {{136, -112}, {202, -152}}, radius = 0), Text(origin = {20, 20}, extent = {{78, 130}, {146, 122}}, textString = "reference speed generation", fontSize = 0, textColor = {255, 0, 0}, horizontalAlignment = TextAlignment.Center), Text(origin = {20, 20}, extent = {{-98, -46}, {-60, -52}}, textString = "PI controller", fontSize = 0, textColor = {255, 0, 0}, horizontalAlignment = TextAlignment.Center), Line(origin = {20, 20}, points = {{-76, -44}, {-57, -23}}, color = {255, 0, 0}, pattern = LinePattern.Solid, thickness = 0.25, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 3, smooth = Smooth.None), Rectangle(origin = {20, 20}, lineColor = {255, 0, 0}, fillColor = {0, 0, 0}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, borderPattern = BorderPattern.None, extent = {{-24, 6}, {100, -50}}, radius = 0), Text(origin = {20, 20}, extent = {{4, 14}, {71, 7}}, textString = "plant (simple drive train)", fontSize = 0, textColor = {255, 0, 0}, horizontalAlignment = TextAlignment.Center)}));
end Resistor;