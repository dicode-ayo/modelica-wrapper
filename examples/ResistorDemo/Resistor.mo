...
equation
  ...
  connect(kinematicPTP1.y[1], integrator1.u) annotation(
    Line(points = {{125, 120}, {132, 120}}, color = {0, 0, 127}));
  ...
  connect(PI1.y, torque1.tau) annotation(
    Line(points = {{161, 80}, {77, 80}, {77, 10}, {-7, 10}}, color = {0, 0, 127}));
  connect(speedSensor1.w, PI1.u_m) annotation(
    Line(points = {{21, -20}, {85.5, -20}, {85.5, 68}, {150, 68}}, color = {0, 0, 127}));
  connect(integrator1.y, PI1.u_s) annotation(
    Line(points = {{155, 120}, {159, 120}, {159, 101}, {129, 101}, {129, 80}, {138, 80}}, color = {0, 0, 127}));
  annotation(
    ...
    Diagram(graphics = {Rectangle(origin = {20, 20}, lineColor = {255, 0, 0}, fillColor = {0, 0, 0}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, borderPattern = BorderPattern.None, extent = {{78, 118}, {144, 78}}, radius = 0), Text(origin = {20, 20}, extent = {{78, 130}, {146, 122}}, textString = "reference speed generation", fontSize = 0, textColor = {255, 0, 0}, horizontalAlignment = TextAlignment.Center), Text(origin = {20, 20}, extent = {{-98, -46}, {-60, -52}}, textString = "PI controller", fontSize = 0, textColor = {255, 0, 0}, horizontalAlignment = TextAlignment.Center), Line(origin = {20, 20}, points = {{-76, -44}, {-57, -23}}, color = {255, 0, 0}, pattern = LinePattern.Solid, thickness = 0.25, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 3, smooth = Smooth.None), Rectangle(origin = {20, 20}, lineColor = {255, 0, 0}, fillColor = {0, 0, 0}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, borderPattern = BorderPattern.None, extent = {{-25, 6}, {99, -50}}, radius = 0), Text(origin = {20, 20}, extent = {{4, 14}, {71, 7}}, textString = "plant (simple drive train)", fontSize = 0, textColor = {255, 0, 0}, horizontalAlignment = TextAlignment.Center)}));
end Resistor;